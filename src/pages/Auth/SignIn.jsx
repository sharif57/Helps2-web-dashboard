...
export default function SignIn() {
  ...
  return (
    <div className="flex flex-col md:flex-row h-screen w-full">
        <div 
          className="w-full md:w-1/2 bg-white flex items-center justify-center p-8 relative"
          style={{
            backgroundImage: "url('/tr 1.png')",
        ...
        >
          ...
          <div className="max-w-[240px] w-full relative z-10">
